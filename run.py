...
from model.models import SimcseModelUnsup, ScratchModelUnsup
...
parser.add_argument('--disable_cuda', default=False, type=bool, help='Whether you want to use cuda or not.')
parser.add_argument('--n_views', default=2, type=int)
parser.add_argument('--do_mlm', default=True, type=bool, help='Choose to add mlm function or not.')
parser.add_argument('--do_train', default=True, type=bool)
parser.add_argument('--do_test', default=True, type=bool)
parser.add_argument('--do_scratch', default=False, type=bool)
...
parser.add_argument("--do_hard_negatives", default=False, help="apply hard negative sample generation or not")
parser.add_argument("--do_tf_idf", default=False, help="create hard negative pairs by replacing words using tf-idf")
parser.add_argument("--token_prob", default=0.5, type=float)
parser.add_argument("--tfidf_mode", default="nbh", choices=["uni", "tfidf", "nbh", "group"])
...
parser.add_argument("--p2_rand", default=False)
# Additional HP
...
def main():
    ...
    if args.do_scratch == True:
        model = ScratchModelUnsup(args=args)
    else:
