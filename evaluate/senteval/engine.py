...
from evaluate.senteval import utils
from evaluate.senteval.binary import CREval, MREval, MPQAEval, SUBJEval
from evaluate.senteval.snli import SNLIEval
from evaluate.senteval.trec import TRECEval
from evaluate.senteval.sick import SICKEntailmentEval, SICKEval
from evaluate.senteval.mrpc import MRPCEval
from evaluate.senteval.sts import STS12Eval, STS13Eval, STS14Eval, STS15Eval, STS16Eval, STSBenchmarkEval, SICKRelatednessEval, STSBenchmarkFinetune
from evaluate.senteval.sst import SSTEval
from evaluate.senteval.rank import ImageCaptionRetrievalEval
from evaluate.senteval.probing import *
